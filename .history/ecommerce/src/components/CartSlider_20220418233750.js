...
handlePrevImage = ()=>{
    ...
    render() {
        ...
        return <CartSliderContainer>
            ...
            {images.length!==0?<div className='next'onClick={this.handleNextImage}><img src={NextArrow} alt="next-arrow"/> </div>:<></>}
            {images.length!==0?<div className='prev' onClick={this.handlePrevImage}> <img src={PrevArrow}alt="prev-arrow" onClick={this.handlePrevImage}/></div>:<></>}

            ...
            <section className="column-container">
              ...
              <div className="attributes-container ">
                {product.attributes.map((item, index) => {
                  let getId = item.id;
                  return [
                    <h2 key={index} className="attribute-header font-700">
                      {item.name + ":"}
                    </h2>,
                    item.type !== "swatch"
                            ...
                            <ButtonDefault
                              ...
                              className={`${
                                this.props.keepButtonActive(getId, item.id,this.props.attributes)
                                  ? "activeButton"
                                  : ""
                              } border-1 text-dark bg-light cursor-pointer btn-margin attribute `}
                              onClick={(e) =>
                                this.props.getSelectedProductSelectedAttributes({
                                  id: getId,
                                  value: item.value,
              ...
              <div>
                ...
                <div className="product-price-value font-700 flex items-center">
                  <span>
              ...
              <div>
               { product.inStock?<AddToCartButton
                 className="bg-primary text-light text-center font-600"
                  to={"/cart"}
                  product={product}
                  onClick={() =>

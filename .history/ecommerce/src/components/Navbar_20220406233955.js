        ...
        <Nav>
          <NavMenu>
            <NavItem className={links[0] === true ? "active" : ""}>
              <NavLink to="/" onClick={() => this.handleOnLinkClick(0)}>
                ALL
              </NavLink>
            </NavItem>
            <NavItem className={links[1] === true ? "active" : ""}>
              <NavLink to="/clothes" onClick={() => this.handleOnLinkClick(1)}>
                Clothing
              </NavLink>
            </NavItem>
            <NavItem className={links[2] === true ? "active" : ""}>
              <NavLink to="/tech" onClick={() => this.handleOnLinkClick(2)}>
                Tech
              </NavLink>
            </NavItem>
          </NavMenu>
          <Center>
            <img src={topBagPart} className="top-bag-part" alt="shopping-bag" />
          ...
          <Right>
            ...
            <ShoppingCartIcon>
             ...
             {this.props.cartItemsCount > 0 ? ( 
                <span className="badge-rounded">{this.props.cartItemsCount}</span>
              ) : (
                ""
              )} 
            </ShoppingCartIcon>

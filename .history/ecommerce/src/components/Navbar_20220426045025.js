      ...
      <header className="bg-light">
        <Container>
          <Nav className="flex items-center flex-space-between text-upper-case">
            <NavMenu className="flex flex-center items-center flex-equal-width">
            ...
            <Center className="flex flex-center h-100 flex-equal-width">
              <img
                src={topBagPart}
            ...
            <div className="flex flex-center items-center h-100 flex-equal-width text-right">
              <CustomDropDownMenu

          ...
          <Nav className="flex items-center flex-space-between">
            <NavMenu className="flex flex-center items-center">
              <NavItem className={links[0] === true ? "active" : ""}>
                <NavLink to="/" onClick={() => this.handleOnLinkClick(0)} className="text-black font-600">
                  ALL
                </NavLink>
              </NavItem>
              ...
              <NavItem className={links[2] === true ? "active" : ""}>
                <NavLink to="/tech" onClick={() => this.handleOnLinkClick(2)} className="text-black text-600">
                  Tech
                </NavLink>
              </NavItem>
            </NavMenu>

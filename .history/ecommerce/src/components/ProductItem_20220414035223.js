      ...
      <Product>
        <LinkContainer to={`/details/${id}${this.props.categoryId}`}>
          <article className="div-1">
            ...
            <div className="product-price">
              <span>{prices[this.props.selectedCurrencyIndex].currency.symbol}</span>
        ...
        {!inStock ? (
          ...
          <div
            className="card-icon"
            onClick={
              ()=>this.props.getCartItemDrfaultAttributesSelection(attributes,this.props.getSelectedProductSelectedAttributes)

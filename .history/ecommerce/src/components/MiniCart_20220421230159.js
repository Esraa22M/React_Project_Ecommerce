              ...
              <Column>
                ...
                <div className="attributes-container">
                  {product.attributes.map((item, index) => {
                    ...
                    return [
                      <h2
                        key={this.props.generateKey(Math.random()*100+ new Date().getMilliseconds())+item.id}
                      ...
                      <div className="flex btn-container">
                        ...
                        {item.type !== "swatch"
                          ? item.items.map((item, index) => {
                              return (
                                <div
                                  key={this.props.generateKey(Math.floor(Math.random() * 100 + new Date().getMilliseconds())
                                    )+item.id}
                          ...
                          : item.items.map((item, index) => {
                              return (
                                <div
                                  key={this.props.generateKey(Math.floor(Math.random() * 100 + new Date().getMilliseconds())+item.id
                                    )}

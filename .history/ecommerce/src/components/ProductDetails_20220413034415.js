...
class ProductDetails extends React.Component {
  ...
  getCartItemDrfaultAttributesSelection = (function () {
    var executed = false;
    return function () {
      if (!executed) {
        executed = true;
  ...
  componentDidUpdate() {
    let{getCartItemDrfaultAttributesSelection,product}=this.props;
    getCartItemDrfaultAttributesSelection([product.attributes]);
  }

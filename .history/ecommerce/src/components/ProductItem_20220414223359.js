...
class ProductItem extends React.Component {
  constructor(props) {
   ...
   getDefaultAttributesSelection = (product)=>{
     ...
     for(let i = 0 ; i < attributes.length ; i++){
       let obj = {};
       obj.id= attributes[i].items[0].id;
  ...
  // componentDidUpdate() {
  //   this.props.getCartItemDrfaultAttributesSelection([...this.props.product.attributes]);
  // }

  render() {
    let { gallery, name, prices, inStock, id, attributes } = this.props.product;

    return (
      <Product>
        <LinkContainer to={`/details/${id}${this.props.categoryId}`}>
          <article className="div-1">
            <div className="product-item-main-content">
        ...
        {!inStock ? (
          ...
          <div
            className="card-icon"
            // () => {
            //   this.props.getCartItemDrfaultAttributesSelection(
            //     attributes,
            ...
            onClick={() => {
               ...
               this.props.getItemsAddedToCart(id , this.props.categoryId , this.getDefaultAttributesSelection(this.props.product))

            }}
            //  ()=> this.props.getItemsAddedToCart(id , this.props.categoryId , this.props.attributes)
          >
            <svg
              width="24"
              height="15.61"

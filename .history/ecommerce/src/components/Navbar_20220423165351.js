      ...
      <header className="bg-light">
        <Container>
          <Nav className="flex items-center flex-space-between text-upper-case">
            <NavMenu className="flex flex-center items-center">
              <NavItem className={links[0] === true ? "active" : ""}>
                <NavLink to="/" onClick={() => this.handleOnLinkClick(0)} className="text-dark font-600 cursor-pointer">
                  ALL
                </NavLink>
              </NavItem>
              ...
              <NavItem className={links[2] === true ? "active" : ""}>
                <NavLink to="/tech" onClick={() => this.handleOnLinkClick(2)} className="text-dark font-600 cursor-pointer">
                  Tech
                </NavLink>
              </NavItem>
            </NavMenu>
            ...
            <div className="flex flex-center items-center h-100">
              <CustomDropDownMenu
                handleCurrencyIndexSelection={
                  this.props.handleCurrencyIndexSelection
                }
              />
              <ShoppingCartIcon onClick={this.props.onCartClick} className="flex flex-column items-center flex-center">

    ...
    return (
      <MiniCartContainer clicked={this.props.isCartClicked ? "flex" : "none"}>
        ...
        {itemsAddedToCart.map((product, index) => {
          return (
            <ProductContainer key={index} className="mini-cart-product-margin">
              <Column>
                        ...
                        {item.type !== "swatch"
                          ? item.items.map((item, index) => {
                              return (
                                <div
                                  key={index}
                                  className={`counter-box flex flex-center btn-font-style  ${
        ...
        <div className="flex-container total-container">
            
            <p className="total">total</p>

          <div><span>esra</span><span></span></div>
        </div>
      </MiniCartContainer>
    );
  }

...
class App extends React.Component {
  ...
  getCartItemDrfaultAttributesSelection = (function (attributes,funct,callbak) {
    var executed = false;
    return function (attributes,funct,callbak) {
      if (!executed) {
